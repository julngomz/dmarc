    ...
    map.current.on('load', () => {
      ...
      try {
        map.current!.addSource(
          "zip-boundaries", {
          type: "vector",
          url: "pmtiles:///pmtiles/des_moines_metro.pmtiles",
          attribution: "US Census Bureau ZCTA Data",
        });
        ...
        map.current!.addLayer({
          ...
          "source-layer": "des_moines_metro", // Match your tippecanoe layer name
          paint: {
            "fill-color": [
              "match",
        ...
        map.current!.on('click', 'zip-fills', (e: maplibregl.MapMouseEvent & { features?: maplibregl.MapGeoJSONFeature[] }) => {
          if (e.features && e.features.length > 0) {
            ...
            map.current!.setPaintProperty('zip-fills', 'fill-color', [
              'match',
              ['get', 'ZCTA5CE20'],
              zipCode, "#1E90FF",
              "#BBDEFB"
